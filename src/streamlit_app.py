...
COUNTRY_CONFIG = {
    ...
    "Australia":    {"methods": ["PayID"],                                                              "currency": "AUD"},
    "Brazil":       {"methods": ["PIX", "Bank Transfer"],                                               "currency": "BRL"},
    "Chile":        {"methods": ["Bank Transfer", "Local Wallet"],                                      "currency": "CLP"},
    "Colombia":     {"methods": ["PSE", "Bank Transfer"],                                               "currency": "COP"},
    "EU":           {"methods": ["Bank Transfer", "SEPA Bank Transfer"],                                "currency": "EUR"},
    "Ghana":        {"methods": ["MTN", "Mobile Money"],                                                "currency": "GHS"},
    "Indonesia":    {"methods": ["Bank Transfer", "QRIS", "Ewallet", "Dana", "OVO"],                   "currency": "IDR"},
    "Japan":        {"methods": ["Bank Transfer"],                                                      "currency": "JPY"},
    "Kenya":        {"methods": ["M-Pesa", "Mobile Money"],                                            "currency": "KES"},
    "Malaysia":     {"methods": ["FPX", "DuitNow"],                                                    "currency": "MYR"},
    ...
    "Philippines":  {"methods": ["ShopeePay", "GrabPay", "GCash", "QRPH", "Bank Transfer", "PayMaya"], "currency": "PHP"},
    "Poland":       {"methods": ["BLIK"],                                                               "currency": "PLN"},
    "Tanzania":     {"methods": ["Bank Transfer", "Mobile Money", "Airtel", "Vodacom M-Pesa"],         "currency": "TZS"},
    "Thailand":     {"methods": ["Thai QR", "Bank Transfer"],                                          "currency": "THB"},
    "Uganda":       {"methods": ["MTN", "Airtel", "Mobile Money"],                                     "currency": "UGX"},
    "USA":          {"methods": ["Bank Transfer"],                                                      "currency": "USD"},
    "Vietnam":      {"methods": ["Local Wallet", "Bank Transfer", "MoMo", "VietQR"],                   "currency": "VND"},
}
